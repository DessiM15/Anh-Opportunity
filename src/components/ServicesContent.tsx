...
export default function ServicesContent() {
  return (
    <>
      ...
      {/* Qualified Plans */}
      <section aria-labelledby="qualified-plans-heading" className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <h2 id="qualified-plans-heading" className="text-3xl md:text-4xl font-bold text-navy mb-4">
              Qualified Plans
            </h2>
      ...
      <section aria-labelledby="nonqualified-heading" className="py-20 md:py-28 bg-light-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <h2 id="nonqualified-heading" className="text-3xl md:text-4xl font-bold text-navy mb-4">
              Non-Qualified Strategies
            </h2>
            <p className="text-navy/60 text-lg mb-12 max-w-2xl">
      ...
      {/* Our Approach */}
      <section aria-labelledby="approach-heading" className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal direction="left">
              <div>
                <h2 id="approach-heading" className="text-3xl md:text-4xl font-bold text-navy mb-6">
                  Our Approach
                </h2>
              ...
              <div className="bg-light-gray rounded-xl p-8 md:p-10">
                <div className="flex items-center gap-4 mb-6">
                  <Image
                    ...
                    alt="3Mark Financial - affiliated partner of Doan Financial Services"
                    width={100}
                    height={35}
      ...
      {/* Contact CTA */}
      <section aria-label="Contact call to action" className="py-20 bg-navy">
          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                aria-label="Call Doan Financial Services at 972-607-1442"
              >
                Call (972) 607-1442
              </a>
              <Link
